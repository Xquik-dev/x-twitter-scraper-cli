...
var xUsersFollowCreate = cli.Command{
	Name:    "create",
	Usage:   "Follow user",
	Suggest: true,
	Flags: []cli.Flag{
	...
	Action:          handleXUsersFollowCreate,
	HideHelpCommand: true,
}

var xUsersFollowDeleteAll = cli.Command{
	Name:    "delete-all",
	Usage:   "Unfollow user",
	Suggest: true,
	Flags: []cli.Flag{
	...
	Action:          handleXUsersFollowDeleteAll,
	HideHelpCommand: true,
}
...
func handleXUsersFollowCreate(ctx context.Context, cmd *cli.Command) error {
	...
	params := xtwitterscraper.XUserFollowNewParams{}
...
func handleXUsersFollowDeleteAll(ctx context.Context, cmd *cli.Command) error {
	...
	params := xtwitterscraper.XUserFollowDeleteAllParams{}
	...
	return ShowJSON(obj, ShowJSONOpts{
		ExplicitFormat: explicitFormat,
		Format:         format,
		Title:          "x:users:follow delete-all",
		Transform:      transform,
	})
}
