...
var xCommunitiesJoinCreate = cli.Command{
	Name:    "create",
	Usage:   "Join community",
	Suggest: true,
	Flags: []cli.Flag{
	...
	Action:          handleXCommunitiesJoinCreate,
	HideHelpCommand: true,
}

var xCommunitiesJoinDeleteAll = cli.Command{
	Name:    "delete-all",
	Usage:   "Leave community",
	Suggest: true,
	Flags: []cli.Flag{
		&requestflag.Flag[string]{
			Name:     "id",
	...
	Action:          handleXCommunitiesJoinDeleteAll,
	HideHelpCommand: true,
}

func handleXCommunitiesJoinCreate(ctx context.Context, cmd *cli.Command) error {
	...
	params := xtwitterscraper.XCommunityJoinNewParams{}
...
func handleXCommunitiesJoinDeleteAll(ctx context.Context, cmd *cli.Command) error {
	...
	params := xtwitterscraper.XCommunityJoinDeleteAllParams{}
